...
# Production deployment script for CoreCRM App
# This script starts the application in production mode with Neon Cloud Database

echo "🚀 Starting CoreCRM App in Production Mode"
echo "==============================================="
...
echo "   Logs: docker logs corecrm-app-prod"
echo ""
echo "Useful commands:"
echo "   View logs: docker logs -f corecrm-app-prod"
